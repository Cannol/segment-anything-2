...
python tools/run_on_lasot_args.py --cfg configs/sam2.1/sam2.1_hiera_b+.yaml --checkpoint checkpoints/sam2.1_hiera_base_plus.pt --dataset test --out_dir results/test/baseline_base_plus
